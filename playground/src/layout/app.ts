  ...
  <div class="h-full flex flex-col bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 transition-colors">
    ...
    <div id="main-split" class="flex flex-col md:flex-row flex-1 min-h-0">
      <div id="panel-editor" class="flex-1 flex flex-col md:border-r border-zinc-200 dark:border-zinc-800 min-h-0">
        <div class="hidden md:block px-4 py-2 text-xs font-medium text-zinc-400 uppercase tracking-wider border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50">Markdown</div>
...
export const editorContainer = $<HTMLDivElement>("#editor-container");
export const preview = $<HTMLDivElement>("#preview");
export const htmlSourceContainer = $<HTMLDivElement>("#html-source");
